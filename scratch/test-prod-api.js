...
(async () => {
  const loginRes = await doFetch('https://nexora-rp09.onrender.com/api/admin/login', 'POST', JSON.stringify({username: 'keshava@5', password: 'admin'}), {'Content-Type': 'application/json'});
